...
const YieldCoupon = () => {
    return (
        <CustomColumn width='80%' alignItems='center' justifyContent='center' gap='1rem'>
            ...
            <CustomColumn width='100%' alignItems='flex-end' justifyContent='center' gap='0.1rem'>
                ...
                <CustomRow width='50%' alignItems='center' justifyContent='flex-end' gap='0.1rem'>
                    ...
                    <CustomFont color='black' font='1rem' fontWeight='bold'>2</CustomFont>
                ...
                <CustomRow width='50%' alignItems='center' justifyContent='flex-end'>
                    <CustomFont color='black' font='0.8rem' fontWeight='bold'>보유 중</CustomFont>
                </CustomRow>
